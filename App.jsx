...
const FOODS = {
  constipation:{
    rec:[
      {name:"차전자피(Psyllium)",reason:"ACG·AGA 강권고. 변비·설사 모두 개선. 물 240ml와 반드시 함께"},
      {name:"귀리·오트밀",reason:"β-글루칸 수용성 섬유질. 장 운동 촉진. 매일 1공기 권장"},
      {name:"키위(2개/일)",reason:"BDA 2024 권장. 자연 완하 효과. 아침 공복에 효과적"},
      {name:"자두·프룬",reason:"소르비톨+섬유질 복합 작용. 3~4개/일. 주스보다 통째로"},
      {name:"아마씨(분쇄)",reason:"오메가3+불용성 섬유질. 물과 함께. 샐러드·요거트에 추가"},
      {name:"시금치",reason:"마그네슘+섬유질. 장 근육 이완. 익혀서 먹으면 더 효과적"},
      {name:"고구마",reason:"불용성 섬유질 풍부. 껍질째 먹으면 효과 배증"},
      {name:"사과(껍질째)",reason:"펙틴+불용성 섬유질. 완전히 익은 것으로"},
      {name:"현미밥",reason:"흰쌀보다 3배 많은 섬유질. 처음엔 반반 섞어 적응"},
      {name:"브로콜리(익힌)",reason:"섬유질+마그네슘. 생것보다 익혀서 가스 줄이기"},
      {name:"콩류(소량)",reason:"단백질+섬유질. 처음엔 소량부터. 복통 시 줄이기"},
      {name:"따뜻한 물(아침)",reason:"공복 따뜻한 물 1컵. 장 운동 활성화"},
    ],
    avoid:[
      {name:"흰쌀밥·흰빵·국수",reason:"정제 탄수화물. 섬유질 거의 없어 장 운동 저하"},
      {name:"붉은 고기(과다)",reason:"포화지방+낮은 섬유질. 주 2회 이하 권장"},
      {name:"치즈·버터",reason:"유지방 과다. 장 운동 저하. 저지방으로 대체"},
      {name:"바나나(덜익은)",reason:"탄닌 성분이 변비 악화. 완전히 익은 것은 OK"},
      {name:"튀김·패스트푸드",reason:"고지방. 장 운동 저하, 소화 지연"},
      {name:"알코올",reason:"탈수 유발. 변비 악화. 음주 시 물 충분히"},
      {name:"카페인(과다)",reason:"이뇨 작용으로 탈수. 하루 1~2잔으로 제한"},
      {name:"가공식품·인스턴트",reason:"섬유질 없고 첨가물 많음. 장 운동 방해"},
    ]
  },
  diarrhea:{
    rec:[
      {name:"흰쌀밥",reason:"BRAT 식단 핵심. 장 점막 자극 없음. 소화 가장 쉬움"},
      {name:"닭가슴살(삶은)",reason:"저지방 단백질. 기름 없이 삶거나 쪄서 섭취"},
      {name:"바나나(잘익은)",reason:"펙틴+칼륨. 전해질 보충. 묽은 변 개선에 효과적"},
      {name:"두부(연두부)",reason:"저FODMAP 단백질. 소화 쉽고 자극 없음"},
      {name:"당근(푹 익힌)",reason:"펙틴 함유. 장 점막 보호. 설사 완화"},
      {name:"차전자피",reason:"수용성 섬유질로 변 굳히기. 물과 함께 반드시"},
      {name:"감자(삶은)",reason:"소화 쉽고 위장 자극 없음. 껍질 제거 후"},
      {name:"쌀죽·미음",reason:"증상 심할 때 최적. 소화 부담 최소화"},
      {name:"삶은 달걀",reason:"단백질 보충. 기름 없이. 하루 1~2개"},
      {name:"연어(구이)",reason:"오메가3 항염. 장 점막 회복에 도움"},
      {name:"두유(저지방)",reason:"우유 대체 단백질. 락토오스 없어 안전"},
      {name:"충분한 수분",reason:"탈수 예방 필수. 하루 2L 이상. 미지근한 물 권장"},
    ],
    avoid:[
      {name:"마늘·양파·대파",reason:"고FODMAP. 가장 흔한 트리거. 소량도 주의"},
      {name:"사과·배·수박·망고",reason:"과당·폴리올 과다. 삼투성 설사 유발"},
      {name:"우유·아이스크림·생크림",reason:"락토오스. 설사형 IBS 대부분 민감"},
      {name:"커피·카페인(과다)",reason:"장 운동 과항진. 빈속 특히 위험"},
      {name:"탄산음료",reason:"가스+당분. 복통·설사 악화"},
      {name:"알코올",reason:"장 점막 직접 자극. 설사 즉각 악화"},
      {name:"기름진 음식·튀김",reason:"지방이 장 운동 촉진. 설사 악화"},
      {name:"매운 음식",reason:"캡사이신이 장 점막 자극. 증상 즉각 악화"},
      {name:"인공감미료(소르비톨 등)",reason:"삼투성 설사 유발. 무설탕 제품에 많음"},
    ]
  },
  mixed:{
    rec:[
      {name:"차전자피",reason:"변비·설사 모두 개선. 혼합형 최우선 권장 섬유질"},
      {name:"흰쌀밥",reason:"안정적 기저 식품. 변화 없을 때 기본으로"},
      {name:"닭가슴살",reason:"저지방 단백질. 어떤 패턴에도 안전"},
      {name:"당근(익힌)",reason:"수용성 섬유질. 변비·설사 모두 완화"},
      {name:"두부",reason:"저FODMAP 단백질. 어떤 패턴에도 안전"},
      {name:"귀리·오트밀",reason:"β-글루칸. 장 환경 안정화. 아침 식사 추천"},
      {name:"바나나(잘익은)",reason:"변비엔 부드럽게, 설사엔 펙틴으로 모두 도움"},
      {name:"삶은 달걀",reason:"단백질 보충. 어떤 패턴에도 소화 잘 됨"},
      {name:"감자(삶은)",reason:"소화 부담 없음. 변비·설사 모두 안전"},
      {name:"시금치(익힌)",reason:"마그네슘. 장 근육 안정에 도움"},
      {name:"두유",reason:"우유 대체. 락토오스 없어 패턴 안정에 도움"},
      {name:"규칙적인 식사시간",reason:"같은 시간에 식사가 장 리듬 안정의 핵심"},
    ],
    avoid:[
      {name:"마늘·양파·대파·파",reason:"고FODMAP. 혼합형에서 가장 흔한 트리거"},
      {name:"밀가루(글루텐)",reason:"프럭탄 함량 높음. 혼합형 증상 악화"},
      {name:"사과·배·복숭아·수박",reason:"과당·폴리올. 설사 패턴 시 특히 주의"},
      {name:"우유·유제품(과다)",reason:"락토오스. 패턴 따라 영향 다름. 소량 테스트"},
      {name:"커피(과다)",reason:"장 운동 과항진. 패턴 불안정 악화"},
      {name:"알코올",reason:"장 점막 자극. 다음날 패턴 불안정"},
      {name:"매운 음식",reason:"캡사이신 자극. 혼합형 특히 예측 불가"},
      {name:"불규칙한 식사",reason:"장 리듬 깨짐. 증상 패턴 악화"},
    ]
  },
  unclassified:{
    rec:[
      {name:"흰쌀밥",reason:"가장 안전한 기저 식품. 증상 관계없이"},
      {name:"닭가슴살(삶은)",reason:"저지방·저FODMAP 단백질. 모든 패턴에 안전"},
      {name:"두부",reason:"저FODMAP. 어떤 증상 패턴에도 안전"},
      {name:"당근(익힌)",reason:"부드럽고 자극 없음. 수용성 섬유질"},
      {name:"차전자피",reason:"증상 패턴 안정화. 꾸준히 복용 권장"},
      {name:"귀리·오트밀",reason:"장 환경 전반 개선. 매일 아침 추천"},
      {name:"삶은 달걀",reason:"완전 단백질. 어떤 패턴에도 소화 잘 됨"},
      {name:"감자(삶은)",reason:"소화 부담 없음. 에너지원으로 안전"},
      {name:"바나나(잘익은)",reason:"칼륨+펙틴. 장 점막 보호"},
      {name:"시금치(익힌)",reason:"마그네슘+섬유질. 장 건강 전반에 도움"},
      {name:"두유",reason:"유제품 대체 단백질. 락토오스 없음"},
      {name:"식사 일기 기록",reason:"패턴 파악이 미분류 IBS의 핵심 치료법"},
    ],
    avoid:[
      {name:"마늘·양파",reason:"고FODMAP. 가장 흔한 트리거. 먼저 제거 시도"},
      {name:"밀가루 음식",reason:"프럭탄. 민감도 테스트 필요"},
      {name:"우유·유제품",reason:"락토오스. 민감 여부 개인마다 다름"},
      {name:"고지방·튀김",reason:"소화 부담. 증상 불안정 악화"},
      {name:"커피·알코올",reason:"장 자극. 증상 불안정 악화"},
      {name:"가공식품·인스턴트",reason:"첨가물이 장 예민성 높임"},
      {name:"불규칙한 식사",reason:"장 리듬 깨짐. 패턴 파악 어려워짐"},
    ]
  },
};
...
const DINING = {
  "한식":[
    {menu:"비빔밥(나물)",safe:true,tip:"고추장·마늘 소스 적게 요청"},
    {menu:"삼계탕",safe:true,tip:"담백하고 소화 쉬움. 마늘은 건져내기"},
    {menu:"콩나물국밥",safe:true,tip:"맑은 국물 선택. 새우젓 소량"},
    {menu:"설렁탕·곰탕",safe:true,tip:"맑은 사골 국물. 파는 적게"},
    {menu:"불고기",safe:true,tip:"양파 적게 요청"},
    {menu:"삼겹살·목살",safe:true,tip:"고기 자체는 안전. 쌈장·마늘 주의"},
    {menu:"생선구이 정식",safe:true,tip:"고등어·삼치·조기 모두 좋아요"},
    {menu:"순두부찌개(순한맛)",safe:true,tip:"맵지 않게 요청"},
    {menu:"된장찌개",safe:false,tip:"마늘·콩 고FODMAP. 소량만"},
    {menu:"김치찌개",safe:false,tip:"발효 양념·마늘 과다"},
    {menu:"부대찌개",safe:false,tip:"가공육+김치+라면 삼중 자극"},
    {menu:"육개장",safe:false,tip:"파·마늘·고춧가루 과다"},
  ],
  "양식":[
    {menu:"그릴드 치킨",safe:true,tip:"소스 별도 요청"},
    {menu:"연어 스테이크",safe:true,tip:"크림 소스 피하기"},
    {menu:"스테이크",safe:true,tip:"소스 별도. 감자 사이드 좋아요"},
    {menu:"샐러드(오일 드레싱)",safe:true,tip:"양파·크루통 빼기. 발사믹OK"},
    {menu:"오트밀 브런치",safe:true,tip:"저FODMAP 토핑으로"},
    {menu:"파스타(크림)",safe:false,tip:"유제품·밀가루 고FODMAP"},
    {menu:"피자",safe:false,tip:"밀가루·치즈·토마토소스 자극"},
    {menu:"햄버거",safe:false,tip:"밀빵+양파+소스. 증상 유발 흔함"},
  ],
  "중식":[
    {menu:"쌀국수",safe:true,tip:"육수 맑은 것. 숙주 듬뿍OK"},
    {menu:"볶음밥(소스 적게)",safe:true,tip:"마늘·양파 최소 요청"},
    {menu:"누룽지탕",safe:true,tip:"담백하고 소화 쉬움"},
    {menu:"짜장면",safe:false,tip:"양파·밀가루 고FODMAP"},
    {menu:"짬뽕",safe:false,tip:"매운 국물+해물+마늘 자극"},
    {menu:"마라탕",safe:false,tip:"강한 자극. IBS 최악 조합"},
    {menu:"탕수육",safe:false,tip:"튀김+설탕 소스"},
  ],
  "일식":[
    {menu:"초밥",safe:true,tip:"와사비 소량. 광어·연어 좋아요"},
    {menu:"연어덮밥",safe:true,tip:"간장 소량"},
    {menu:"소바(메밀국수)",safe:true,tip:"메밀은 저FODMAP. 쯔유 적게"},
    {menu:"생선구이 정식",safe:true,tip:"담백하고 안전"},
    {menu:"라멘",safe:false,tip:"밀면+진한 국물+마늘 기름"},
    {menu:"우동",safe:false,tip:"밀가루 면. 민감하면 주의"},
    {menu:"돈가스",safe:false,tip:"튀김옷+소스. 소화 부담"},
  ],
  "카페":[
    {menu:"아메리카노(소량)",safe:true,tip:"빈속 금지. 하루 1~2잔"},
    {menu:"두유라떼",safe:true,tip:"우유 대신 두유 변경"},
    {menu:"락토프리 라떼",safe:true,tip:"락토프리 우유 옵션 활용"},
    {menu:"허브티·캐모마일",safe:true,tip:"장 진정 효과. 카페인 없음"},
    {menu:"쌀 베이커리",safe:true,tip:"쌀빵·글루텐프리 옵션"},
    {menu:"라떼(우유)",safe:false,tip:"우유 락토오스"},
    {menu:"케이크·머핀",safe:false,tip:"밀가루·설탕·크림 과다"},
    {menu:"스무디(과일)",safe:false,tip:"사과·망고 등 고FODMAP 과일 주의"},
  ],
  "배달·야식":[
    {menu:"보쌈(고기만)",safe:true,tip:"김치·마늘 빼고 고기+쌈채소"},
    {menu:"족발(앞다리)",safe:true,tip:"고기 자체는 저FODMAP. 소스 주의"},
    {menu:"닭백숙·닭곰탕",safe:true,tip:"담백. 마늘 건져내기"},
    {menu:"회·물회(맵지않게)",safe:true,tip:"생선 자체는 안전. 초장 적게"},
    {menu:"샐러드 도시락",safe:true,tip:"드레싱 별도·양파 빼기"},
    {menu:"치킨(후라이드)",safe:false,tip:"튀김 기름. 야식으론 최악"},
    {menu:"양념치킨",safe:false,tip:"튀김+마늘 양념 이중 자극"},
    {menu:"곱창·막창구이",safe:false,tip:"고지방. 밤에 특히 부담"},
    {menu:"라면·컵라면",safe:false,tip:"밀면+수프(마늘·양파 분말)"},
    {menu:"피자·떡볶이 세트",safe:false,tip:"야식 증상 유발 1순위"},
  ],
  "분식":[
    {menu:"김밥(참치·야채)",safe:true,tip:"단무지·햄 적은 것으로"},
    {menu:"어묵탕",safe:true,tip:"어묵은 저FODMAP. 국물 좋아요"},
    {menu:"오징어튀김(소량)",safe:true,tip:"오징어 자체는 안전. 소량만"},
    {menu:"잔치국수",safe:false,tip:"밀면. 멸치육수는 좋으나 면 주의"},
    {menu:"떡볶이",safe:false,tip:"밀떡+고추장. 쌀떡도 양념 자극"},
    {menu:"순대",safe:false,tip:"당면+선지. 사람따라 편차 큼"},
    {menu:"튀김 모둠",safe:false,tip:"밀가루 튀김옷+기름"},
    {menu:"만두",safe:false,tip:"밀피+양파·부추 속"},
  ],
};
...
const FODMAP_LV = {
  // 밥·면·빵
  "흰쌀밥":"low","현미밥":"low","잡곡밥":"low","보리밥":"high","콩밥":"high",
  "귀리·오트밀":"low","쌀국수":"low","당면":"mid","쌀떡":"mid","찹쌀떡":"high",
  "식빵":"high","통밀빵":"high","쌀빵":"low","글루텐프리빵":"low",
  "라면":"high","우동":"high","소바(메밀면)":"low","파스타":"high",
  "칼국수":"high","수제비":"high","쫄면":"high","비빔국수":"high",
  "잔치국수":"high","냉면(물)":"low","냉면(비빔)":"mid","떡":"mid","떡국":"mid",
  // 육류·단백질
  "닭가슴살":"low","닭다리":"low","닭날개":"low","삼계탕":"mid",
  "삼겹살":"low","목살":"low","항정살":"low","제육볶음":"high",
  "소고기":"low","불고기":"high","갈비":"mid","갈비탕":"mid","설렁탕":"low",
  "곰탕":"low","육개장":"high","차돌박이":"low","등심":"low","안심":"low",
  "계란":"low","삶은계란":"low","훈제계란":"low","계란빵":"mid","계란찜":"low",
  "연어":"low","고등어":"low","참치":"low","광어":"low","우럭":"low",
  "새우":"low","오징어":"low","문어":"low","낙지":"low","꽃게":"low",
  "두부":"low","연두부":"low","순두부":"low","두부바":"low","유부":"low",
  "어묵":"low","맛살":"low","소시지":"low","비엔나소시지":"low",
  "족발":"low","보쌈":"mid","순대":"mid","곱창":"low","막창":"low",
  // 채소
  "상추":"low","깻잎":"low","시금치":"low","부추":"high","쑥갓":"low",
  "당근":"low","당근(익힌)":"low","오이":"low","애호박":"low","피망":"low",
  "파프리카":"low","브로콜리":"mid","콜리플라워":"high","양배추":"mid",
  "토마토":"low","방울토마토":"low","가지":"low","고추":"low","청양고추":"low",
  "무":"low","연근":"mid","우엉":"high","숙주":"low","콩나물":"low",
  "마늘":"high","양파":"high","대파":"high","파":"mid","쪽파":"high",
  "생강":"low","강황":"low","미나리":"low","취나물":"low","도라지":"low",
  // 과일
  "딸기":"low","블루베리":"low","포도":"low","키위":"low","오렌지":"low",
  "귤":"low","레몬":"low","자몽":"low","파인애플":"low","수박":"high",
  "참외":"high","멜론":"high","망고":"high","사과":"high","배":"high",
  "복숭아":"high","자두":"mid","체리":"high","바나나(익은)":"low","바나나(덜익은)":"mid",
  "아보카도":"mid","코코넛":"mid","감":"mid","무화과":"high","석류":"mid",
  // 유제품
  "우유":"high","흰우유":"high","락토프리우유":"low",
  "두유":"low","아몬드밀크":"low","귀리밀크":"mid","코코넛밀크":"mid",
  "요구르트(액상)":"mid","요구르트(고형)":"mid","그릭요거트":"mid",
  "아이스크림":"high","치즈(슬라이스)":"mid","크림치즈":"mid","모짜렐라":"mid",
  "파르메산":"low","버터":"low","생크림":"high",
  // 한식 국물
  "미역국":"low","콩나물국":"low","북엇국":"low","황태해장국":"low","뭇국":"low",
  "감자국":"low","시금치된장국":"mid","두부된장국":"mid","된장찌개":"mid",
  "순두부찌개":"low","순두부찌개(매운)":"mid","동태찌개":"mid","해물탕":"mid",
  "갈비탕":"mid","삼계탕":"mid","내장탕":"mid","선지국":"low","순댓국":"mid",
  "부대찌개":"high","김치찌개":"high","청국장":"high","어묵탕":"mid",
  // 한식 반찬
  "김치":"high","깍두기":"high","총각김치":"high","열무김치":"high","백김치":"mid",
  "콩나물무침":"low","나물(시금치)":"low","나물(고사리)":"low",
  "멸치볶음":"low","계란말이":"low","잡채":"high","부침개":"high",
  "갈비찜":"mid","장조림":"low","조기구이":"low","고등어구이":"low","삼치구이":"low",
  // 분식
  "떡볶이":"high","떡볶이(밀떡)":"high","떡볶이(쌀떡)":"mid","라볶이":"high",
  "튀김(야채)":"mid","튀김(오징어)":"low","순대":"mid",
  "김밥":"mid","참치김밥":"low","치즈김밥":"mid","야채김밥":"mid",
  "떡꼬치":"mid","호떡":"high","붕어빵":"high",
  "핫도그":"high","군만두":"high","물만두":"high","만두":"high",
  "닭강정":"high","치킨(후라이드)":"high","치킨(양념)":"high",
  // 외식·배달
  "짜장면":"high","짬뽕":"high","볶음밥":"high","탕수육":"high",
  "피자":"high","햄버거":"high","파스타(크림)":"high","파스타(토마토)":"high",
  "스테이크":"low","샐러드":"low","샌드위치":"high",
  "마라탕":"high","마라샹궈":"high","쌀국수(베트남)":"low","월남쌈":"low",
  "초밥":"low","회":"low","연어덮밥":"low","규동":"high",
  "라멘":"high","돈가스":"high","오므라이스":"high",
  // 편의점·간식
  "삼각김밥(참치)":"low","삼각김밥(연어)":"low","삼각김밥(불고기)":"high",
  "즉석밥":"low","컵라면":"high","컵밥":"mid","편의점도시락":"mid",
  "닭가슴살(편의점)":"low","삶은계란":"low","훈제계란":"low",
  "감자칩":"low","쌀과자":"low","팝콘":"low","프레첼":"high","크래커":"high",
  "꿀과자":"high","초코파이":"high","카스테라":"high","머핀":"high","빵(크림)":"high",
  "아몬드":"mid","호두":"low","땅콩":"low","캐슈넛":"high","믹스넛":"mid",
  "초콜릿":"mid","사탕":"low","젤리":"mid",
  // 음료
  "커피(블랙)":"low","아메리카노":"low","아메리카노(편의점)":"low",
  "라떼(우유)":"high","두유라떼":"low","녹차":"low","홍차":"mid","허브티":"low",
  "탄산음료":"mid","에너지드링크":"mid","이온음료":"low","식혜":"high",
  "오렌지주스":"mid","사과주스":"high","포도주스":"mid","토마토주스":"low",
  "두유":"low","두유(편의점)":"low","바나나우유":"high","초코우유":"high",
  "소주":"low","맥주":"high","와인":"mid","막걸리":"high","청주":"mid",
  // 양념·소스
  "간장":"low","된장":"mid","고추장":"high","쌈장":"high","굴소스":"mid",
  "올리브오일":"low","참기름":"low","식초":"low","설탕":"low",
  "꿀":"high","올리고당":"high","케첩":"low","마요네즈":"low","머스타드":"low",
  // 건강식품
  "차전자피":"low","아마씨":"low","치아씨드":"low",
  "프로틴바":"mid","두유단백질":"low",
  "김":"low","미역":"low","다시마":"low","파래":"low",
};
...
function ReportPanel({logs,repPeriod,setRepPeriod,C}) {
  ...
  const bwStats=(()=>{
    const arr=pData.filter(e=>e.bowel&&e.bowel.cnt!==null&&e.bowel.cnt!==undefined);
    if(!arr.length)return null;
    const types=arr.filter(e=>e.bowel.type).map(e=>e.bowel.type);
    let mode=null;
    if(types.length){const c={};types.forEach(t=>c[t]=(c[t]||0)+1);mode=Object.entries(c).sort((a,b)=>b[1]-a[1])[0][0];}
    const avgCnt=arr.reduce((a,e)=>a+e.bowel.cnt,0)/arr.length;
    return {n:arr.length,mode,avgCnt};
  })();
  const wtStats=(()=>{
    const arr=pData.filter(e=>e.water);
    if(!arr.length)return null;
    return {n:arr.length,avg:arr.reduce((a,e)=>a+e.water,0)/arr.length};
  })();
  const saveImage = () => {
    try {
      const W=720; const FFC="'Noto Sans KR',sans-serif";
      const bad=pData.filter(e=>(e.pain||0)>=2||(e.comfort??3)<=1);
      const fcnt={}; bad.forEach(e=>(e.foods||[]).forEach(f=>fcnt[f]=(fcnt[f]||0)+1));
      const topF=Object.entries(fcnt).sort((a,b)=>b[1]-a[1]).slice(0,3);
      const bwArr=pData.filter(e=>e.bowel&&e.bowel.type).map(e=>e.bowel.type);
      const wArr=pData.filter(e=>e.water).map(e=>e.water);
      const H=560+(weeks.length>=2?170:0)+(topF.length?60:0)+((bwArr.length||wArr.length)?60:0);
      const cv=document.createElement("canvas"); cv.width=W*2; cv.height=H*2;
      const ctx=cv.getContext("2d"); ctx.scale(2,2);
      const rr=(x,y,w2,h2,r,col)=>{ctx.fillStyle=col;ctx.beginPath();if(ctx.roundRect)ctx.roundRect(x,y,w2,h2,r);else ctx.rect(x,y,w2,h2);ctx.fill();};
      const tx=(t,x,y,size,col,w3,align)=>{ctx.fillStyle=col;ctx.font=(w3||400)+" "+size+"px "+FFC;ctx.textAlign=align||"left";ctx.fillText(t,x,y);};
      rr(0,0,W,H,0,"#F6F4EE");
      rr(0,0,W,96,0,"#4A7C59");
      tx("🌿 소나장",32,42,24,"#fff",700);
      tx("장 건강 리포트",32,72,15,"rgba(255,255,255,0.85)");
      tx(new Date().toLocaleDateString("ko-KR",{year:"numeric",month:"long",day:"numeric"})+" 생성",W-32,58,13,"rgba(255,255,255,0.7)",400,"right");
      tx("기간: 최근 "+repPeriod+"일  ·  기록 "+pData.length+"회",32,132,15,"#5C4F3A",600);
      let y=156;
      const cardW=(W-64-16)/2;
      rr(32,y,cardW,190,16,"#FEFCF7");
      ctx.textAlign="center";
      tx(painEmoji(curPain),32+cardW/2,y+64,44,"#000",400,"center");
      tx(painText(curPain),32+cardW/2,y+108,24,curPain<0.5?"#4A7C59":curPain<1.5?"#C8936E":"#B85450",800,"center");
      tx("평균 복통",32+cardW/2,y+134,13,"#9C8F7A",400,"center");
      if(painDiff!==null)tx(painDiff<-0.2?"▼ "+Math.abs(painDiff).toFixed(1)+" 개선":painDiff>0.2?"▲ "+painDiff.toFixed(1)+" 악화":"변화 없음",32+cardW/2,y+164,13,painDiff<-0.2?"#4A7C59":painDiff>0.2?"#B85450":"#9C8F7A",700,"center");
      rr(48+cardW,y,cardW,190,16,"#FEFCF7");
      tx(comfEmoji(curComf),48+cardW+cardW/2,y+64,44,"#000",400,"center");
      tx(comfText(curComf),48+cardW+cardW/2,y+108,24,curComf>=3?"#4A7C59":curComf>=2?"#C8936E":"#B85450",800,"center");
      tx("평균 컨디션",48+cardW+cardW/2,y+134,13,"#9C8F7A",400,"center");
      if(comfDiff!==null)tx(comfDiff>0.2?"▲ "+comfDiff.toFixed(1)+" 좋아짐":comfDiff<-0.2?"▼ "+Math.abs(comfDiff).toFixed(1)+" 나빠짐":"변화 없음",48+cardW+cardW/2,y+164,13,comfDiff>0.2?"#4A7C59":comfDiff<-0.2?"#B85450":"#9C8F7A",700,"center");
      y+=214;
      if(weeks.length>=2){
        rr(32,y,W-64,150,16,"#FEFCF7");
        tx("주별 복통 변화 (낮을수록 좋아요)",52,y+30,14,"#2C2417",700);
        const chartX=52, chartW=W-104, barW=Math.min(56,(chartW/weeks.length)-14), base=y+118, maxH=64;
        weeks.forEach((w,i)=>{
          const bx=chartX+(chartW/weeks.length)*i+(chartW/weeks.length-barW)/2;
          const bh=Math.max(6,(w.pain/maxPain)*maxH);
          const col=w.pain<0.5?"#4A7C59":w.pain<1.5?"#C8936E":"#B85450";
          rr(bx,base-bh,barW,bh,4,col);
          tx(w.label,bx+barW/2,base+18,11,"#9C8F7A",400,"center");
        });
        y+=170;
      }
      if(topF.length){
        rr(32,y,W-64,44,12,"#FDF0EF");
        tx("⚠ 나쁜 날 자주 함께한 음식: "+topF.map(([f,c])=>f+"("+c+")").join(", "),52,y+28,13,"#B85450",600);
        y+=60;
      }
      if(bwArr.length||wArr.length){
        rr(32,y,W-64,44,12,"#EAF2EC");
        let info=[];
        if(bwArr.length){const cnt2={};bwArr.forEach(t=>cnt2[t]=(cnt2[t]||0)+1);const mode=Object.entries(cnt2).sort((a,b)=>b[1]-a[1])[0][0];info.push("배변 주요 형태: 브리스톨 "+mode+"형");}
        if(wArr.length)info.push("물 평균 "+(wArr.reduce((a,b)=>a+b,0)/wArr.length).toFixed(1)+"컵/일");
        tx("🚽 "+info.join("  ·  "),52,y+28,13,"#4A7C59",600);
        y+=60;
      }
      ctx.textAlign="center";
      tx("sonajang.vercel.app  ·  참고용 기록이며 의학적 진단을 대체하지 않습니다",W/2,H-24,11,"#9C8F7A",400,"center");
      cv.toBlob(b=>{
        const a=document.createElement("a");
        a.href=URL.createObjectURL(b);
        a.download="소나장_리포트_"+new Date().toISOString().slice(0,10)+".png";
        a.click();
        setTimeout(()=>URL.revokeObjectURL(a.href),1000);
      },"image/png");
    } catch(e) { alert("이미지 저장에 실패했어요. 다시 시도해주세요."); }
  };
  return (
    <div>
      ...
      <button onClick={saveImage} style={{width:"100%",padding:"10px",background:C.surface,color:C.primary,border:`1.5px solid ${C.safeBorder}`,borderRadius:10,fontSize:12.5,fontWeight:700,cursor:"pointer",marginBottom:14}}>📷 리포트 이미지 저장 — 병원 진료 때 보여주세요</button>
      ...
      {(bwStats||wtStats)&&(
        <div style={{display:"grid",gridTemplateColumns:bwStats&&wtStats?"1fr 1fr":"1fr",gap:8,marginBottom:12}}>
          {bwStats&&(
            <div style={{background:C.surface,borderRadius:14,padding:"12px",border:`1px solid ${C.border}`,textAlign:"center"}}>
              <div style={{fontSize:24,marginBottom:2}}>🚽</div>
              <div style={{fontSize:15,fontWeight:800,color:bwStats.mode?(bwStats.mode<=2?C.caution:bwStats.mode<=4?C.safe:bwStats.mode==5?C.caution:C.warn):C.text}}>{bwStats.mode?`주로 ${bwStats.mode}형`:"형태 미기록"}</div>
              <div style={{fontSize:10.5,color:C.textMuted,marginTop:2}}>평균 {bwStats.avgCnt.toFixed(1)}회/일 · {bwStats.n}일 기록</div>
              {bwStats.mode&&<div style={{fontSize:10,color:C.textMuted,marginTop:4}}>{bwStats.mode<=2?"변비 경향":bwStats.mode<=4?"정상 범위 👍":"무른 변 경향"}</div>}
            </div>
          )}
          {wtStats&&(
            <div style={{background:C.surface,borderRadius:14,padding:"12px",border:`1px solid ${C.border}`,textAlign:"center"}}>
              <div style={{fontSize:24,marginBottom:2}}>💧</div>
              <div style={{fontSize:15,fontWeight:800,color:wtStats.avg>=5?"#5B9BD5":C.caution}}>평균 {wtStats.avg.toFixed(1)}컵</div>
              <div style={{fontSize:10.5,color:C.textMuted,marginTop:2}}>약 {Math.round(wtStats.avg*250)}ml/일 · {wtStats.n}일 기록</div>
              <div style={{fontSize:10,color:C.textMuted,marginTop:4}}>{wtStats.avg>=6?"충분해요 👍":wtStats.avg>=4?"조금 더 마셔요":"수분 부족 — 더 마셔요"}</div>
            </div>
          )}
        </div>
      )}
...
function Step1Panel({foods,setFoods,meal,setMeal,mealIdx,setMealIdx,mealFoods,setMealFoods,custom,setCustom,showAI,setShowAI,aiText,setAiText,aiImg,setAiImg,aiPrev,setAiPrev,aiRes,setAiRes,aiErr,setAiErr,aiLoad,analyzeAI,handleImg,fileRef,setStep,C}) {
  return (
    <div>
      ...
      <div style={{fontSize:11,color:C.textMuted,marginBottom:6}}>빠른 선택 / 검색</div>
      <div style={{display:"flex",gap:6,marginBottom:8}}>
        <input value={custom} onChange={e=>setCustom(e.target.value)} onKeyDown={e=>{if(e.key==="Enter"&&custom.trim()){setFoods(p=>[...p,custom.trim()]);setCustom("");}}} placeholder="🔍 음식 검색 또는 직접 입력 + Enter" style={{flex:1,padding:"9px 12px",border:`1.5px solid ${custom.trim()?C.primary:C.border}`,borderRadius:9,fontSize:12,outline:"none",background:C.surfaceAlt}} />
        <button onClick={()=>{if(custom.trim()){setFoods(p=>[...p,custom.trim()]);setCustom("");}}} style={{padding:"9px 14px",background:C.primary,color:"#fff",border:"none",borderRadius:9,fontSize:12,cursor:"pointer",fontWeight:700}}>추가</button>
      </div>
      <div style={{display:"flex",flexWrap:"wrap",gap:5,marginBottom:10}}>
        {(custom.trim() ? QUICK.filter(f=>f.includes(custom.trim())) : QUICK).map(f=>{
        ...
        {custom.trim()&&!QUICK.some(f=>f.includes(custom.trim()))&&(
          <button onClick={()=>{setFoods(p=>[...p,custom.trim()]);setCustom("");}} style={{padding:"5px 11px",borderRadius:20,border:`1.5px solid ${C.gold}`,background:C.goldLight,color:C.gold,fontSize:12,fontWeight:700,cursor:"pointer"}}>+ "{custom.trim()}" 추가</button>
        )}
      </div>
      {foods.length>0&&(
    ...
    <div>
      {q.showForm ? (
        ...
        <div>
          ...
          {q.logView==="list"&&<LogListView logs={q.logs} setEditingId={q.setEditingId} setLogDate={q.setLogDate} setMeal={q.setMeal} setMealFoods={q.setMealFoods} setFoods={q.setFoods} setPain={q.setPain} setBloating={q.setBloating} setComfort={q.setComfort} setNote={q.setNote} setMealSymptoms={q.setMealSymptoms} setSleep={q.setSleep} setStress={q.setStress} setActivity={q.setActivity} setBowel={q.setBowel} setWater={q.setWater} setMeds={q.setMeds} setStep={q.setStep} setShowForm={q.setShowForm} setLogs={q.setLogs} C={C} />}
          {q.logView==="list"&&<BackupPanel logs={q.logs} setLogs={q.setLogs} C={C} />}
...
function FodmapSearch({C}) {
  ...
  const go=async()=>{
    ...
    try{
      const r=await fetch("/api/fodmap",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({query})});
      const j=await r.json();
      if(j.error)throw new Error(j.error);
      if(!j.lv)throw new Error("응답 형식 오류");
      setRes({name:query,lv:j.lv,reason:j.reason,src:"ai"});
    }catch(e){setRes({name:query,lv:null,src:"err",msg:"DB에 없는 음식이에요. 추후 AI 검색으로 분석 예정입니다."});}
  ...
  return (
    <div style={{background:C.surface,borderRadius:14,padding:16,border:`1px solid ${C.border}`,marginBottom:16}}>
      ...
      {res&&res.src==="err"&&<div style={{padding:"10px 12px",background:C.warnBg,borderRadius:9,fontSize:12,color:C.warn,marginTop:8}}>{res.msg||"오류 발생. 다시 시도해주세요."}</div>}
...
function TriggerView({logs,C}) {
  ...
  const lifeFactors=[
    {label:"😴 수면 부족",test:e=>e.sleep===0,has:e=>e.sleep!==null&&e.sleep!==undefined},
    {label:"😣 높은 스트레스",test:e=>e.stress===2,has:e=>e.stress!==null&&e.stress!==undefined},
    {label:"🚶 활동량 부족",test:e=>e.activity===0,has:e=>e.activity!==null&&e.activity!==undefined},
    {label:"💧 물 2컵 이하",test:e=>e.water<=2,has:e=>!!e.water},
  ];
  const lifeHasData=lifeFactors.some(f=>base.some(f.has));
  const lifeSus=lifeFactors.map(f=>{
    const bH=bad.filter(f.has), gH=good.filter(f.has);
    const bR=bH.length?bH.filter(f.test).length/bH.length:0;
    const gR=gH.length?gH.filter(f.test).length/gH.length:0;
    return {label:f.label,bR,gR,bCnt:bH.filter(f.test).length};
  }).filter(x=>x.bCnt>=2&&x.bR>x.gR+0.15).sort((a,b)=>(b.bR-b.gR)-(a.bR-a.gR));
  const painC = v => v===0?C.safe:v===1?C.caution:C.warn;
  return (
    <div>
      ...
      <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:14,marginBottom:12}}>
        <div style={{fontSize:13,fontWeight:700,color:C.text,marginBottom:3}}>생활 요인 영향</div>
        <div style={{fontSize:10.5,color:C.textMuted,marginBottom:10}}>나쁜 날과 좋은 날에 이 요인이 얼마나 자주 있었는지 비교해요.</div>
        {!lifeHasData?(
          <div style={{fontSize:12,color:C.textMuted,textAlign:"center",padding:"12px 0"}}>수면·스트레스·물을 기록하면 생활 요인 분석이 시작돼요.</div>
        ):lifeSus.length===0?(
          <div style={{fontSize:12,color:C.textMuted,textAlign:"center",padding:"12px 0"}}>생활 요인과 증상 사이 뚜렷한 패턴이 아직 없어요.</div>
        ):(
          <div>
            {lifeSus.map(x=>(
              <div key={x.label} style={{marginBottom:12}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:4}}>
                  <span style={{fontSize:12,fontWeight:700,color:C.text}}>{x.label}</span>
                  <span style={{fontSize:10.5,color:C.textMid}}><b style={{color:C.warn}}>나쁜날 {Math.round(x.bR*100)}%</b> · 좋은날 {Math.round(x.gR*100)}%</span>
                </div>
                <div style={{height:4,background:C.border,borderRadius:2,overflow:"hidden",marginBottom:3}}>
                  <div style={{width:`${x.bR*100}%`,height:"100%",background:C.warn,borderRadius:2}} />
                </div>
                <div style={{height:4,background:C.border,borderRadius:2,overflow:"hidden"}}>
                  <div style={{width:`${x.gR*100}%`,height:"100%",background:C.safe,borderRadius:2}} />
                </div>
              </div>
            ))}
            <div style={{fontSize:10,color:C.textMuted,display:"flex",gap:10}}>
              <span style={{display:"flex",alignItems:"center",gap:3}}><span style={{width:7,height:7,borderRadius:2,background:C.warn,display:"inline-block"}} />나쁜 날 비율</span>
              <span style={{display:"flex",alignItems:"center",gap:3}}><span style={{width:7,height:7,borderRadius:2,background:C.safe,display:"inline-block"}} />좋은 날 비율</span>
            </div>
          </div>
        )}
      </div>
...
function BackupPanel({logs,setLogs,C}) {
  const fileRef = useRef(null);
  const [msg, setMsg] = useState("");
  const doExport = () => {
    try {
      const data = {app:"sonajang", version:1, exportedAt:new Date().toISOString(),
        type: localStorage.getItem("ibs-type")||null,
        fodPhase: JSON.parse(localStorage.getItem("ibs-fodphase")||"0"),
        fodResults: JSON.parse(localStorage.getItem("ibs-fodresults")||"{}"),
        logs};
      const blob = new Blob([JSON.stringify(data,null,2)],{type:"application/json"});
      const url = URL.createObjectURL(blob);
      const a = document.createElement("a");
      a.href = url;
      a.download = "소나장_백업_"+new Date().toISOString().slice(0,10)+".json";
      a.click();
      URL.revokeObjectURL(url);
      setMsg("✓ 백업 파일이 다운로드됐어요!");
      setTimeout(()=>setMsg(""),3000);
    } catch(e) { setMsg("백업 실패. 다시 시도해주세요."); setTimeout(()=>setMsg(""),3000); }
  };
  const doImport = (e) => {
    ...
    reader.onload = (ev) => {
      try {
        ...
        if (data.app!=="sonajang"||!Array.isArray(data.logs)) throw new Error("형식 오류");
        if (!window.confirm("백업 파일에서 "+data.logs.length+"개 기록을 불러올까요?\n현재 기록과 합쳐지며, 같은 기록은 중복되지 않아요.")) return;
        setLogs(prev => {
          const ids = new Set(prev.map(l=>l.id));
          const merged = [...prev, ...data.logs.filter(l=>!ids.has(l.id))];
          return merged.sort((a,b)=>(b.isoDate||"").localeCompare(a.isoDate||""));
        });
        if (data.type) try{localStorage.setItem("ibs-type",data.type);}catch(err){}
        setMsg("✓ 기록을 불러왔어요! 새로고침하면 유형도 복원돼요.");
        setTimeout(()=>setMsg(""),4000);
      } catch(err) { setMsg("파일을 읽을 수 없어요. 소나장 백업 파일인지 확인해주세요."); setTimeout(()=>setMsg(""),4000); }
    };
    reader.readAsText(file);
    e.target.value = "";
  };
  const doReset = () => {
    if (!window.confirm("모든 기록과 설정을 삭제할까요?\n삭제 전 '내보내기'로 백업을 권장해요.")) return;
    if (!window.confirm("정말 삭제할까요? 되돌릴 수 없어요.")) return;
    try {
      ["ibs-type","ibs-logs","ibs-agreed","ibs-fodphase","ibs-fodresults"].forEach(k=>localStorage.removeItem(k));
      window.location.reload();
    } catch(e) { setMsg("초기화에 실패했어요."); setTimeout(()=>setMsg(""),3000); }
  };
  return (
    <div style={{background:C.surface,borderRadius:12,padding:"12px 14px",border:`1px solid ${C.border}`,marginTop:14}}>
      <div style={{fontSize:12,fontWeight:700,color:C.text,marginBottom:3}}>💾 기록 백업</div>
      <div style={{fontSize:10.5,color:C.textMuted,lineHeight:1.6,marginBottom:10}}>기록은 이 기기에만 저장돼요. 폰을 바꾸거나 초기화하기 전에 백업 파일을 저장해두세요.</div>
      <div style={{display:"flex",gap:8}}>
        <button onClick={doExport} disabled={!logs.length} style={{flex:1,padding:"9px",background:logs.length?C.primary:C.border,color:"#fff",border:"none",borderRadius:9,fontSize:12,fontWeight:700,cursor:logs.length?"pointer":"default"}}>내보내기</button>
        <button onClick={()=>fileRef.current&&fileRef.current.click()} style={{flex:1,padding:"9px",background:C.surfaceAlt,color:C.textMid,border:`1.5px solid ${C.border}`,borderRadius:9,fontSize:12,fontWeight:700,cursor:"pointer"}}>가져오기</button>
        <input ref={fileRef} type="file" accept=".json,application/json" onChange={doImport} style={{display:"none"}} />
      </div>
      <button onClick={doReset} style={{width:"100%",marginTop:8,padding:"8px",background:"transparent",color:C.warn,border:`1px solid ${C.warnBorder}`,borderRadius:9,fontSize:11.5,fontWeight:600,cursor:"pointer"}}>🗑 전체 초기화 (기록·설정 모두 삭제)</button>
      {msg&&<div style={{fontSize:11,color:msg.startsWith("✓")?C.safe:C.warn,marginTop:8,fontWeight:600}}>{msg}</div>}
    </div>
  );
}
function LogListView({logs,setEditingId,setLogDate,setMeal,setMealFoods,setFoods,setPain,setBloating,setComfort,setNote,setMealSymptoms,setSleep,setStress,setActivity,setBowel,setWater,setMeds,setStep,setShowForm,setLogs,C}) {
  const painC = v => v===0?C.safe:v===1?C.caution:C.warn;
  const comfC = v => v>=3?C.safe:v>=2?C.caution:C.warn;
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:8,gap:6}}>
            ...
            <div style={{display:"flex",gap:3,flexWrap:"wrap",justifyContent:"flex-end"}}>
              ...
              <button onClick={()=>{
                ...
                setSleep(entry.sleep??null); setStress(entry.stress??null); setActivity(entry.activity??null); setBowel(entry.bowel||{cnt:null,type:null}); setWater(entry.water??null); setMeds(entry.meds||[]);
...
function Step2Panel({mealFoods,mealSymptoms,setMealSymptoms,symMeal,setSymMeal,note,setNote,sleep,setSleep,stress,setStress,activity,setActivity,bowel,setBowel,water,setWater,meds,setMeds,saveLog,setStep,editingId,C}) {
  ...
  return (
    <div>
      ...
      <div style={{marginBottom:14,paddingTop:14,borderTop:`1px solid ${C.border}`}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
          <div style={{fontSize:11.5,fontWeight:700,color:C.textMuted}}>💧 물 섭취량 (선택)</div>
          <div style={{fontSize:11,color:water?"#5B9BD5":C.textMuted,fontWeight:water?700:400}}>{water?`${water}컵 · 약 ${water*250}ml`:"1컵 ≈ 250ml"}</div>
        </div>
        <div style={{display:"flex",gap:4}}>
          {[1,2,3,4,5,6,7,8].map(n=>{
            const filled=water!==null&&n<=water;
            return <button key={n} onClick={()=>setWater(water===n?null:n)}
              style={{flex:1,padding:"8px 0",borderRadius:8,border:`1.5px solid ${filled?"#5B9BD5":C.border}`,background:filled?"#EAF3FB":C.surfaceAlt,fontSize:13,cursor:"pointer",lineHeight:1}}>{filled?"💧":"·"}</button>;
          })}
        </div>
      </div>
      {(()=>{
        const bw=bowel||{cnt:null,type:null};
        const BRISTOL={1:"1형 — 토끼똥처럼 딱딱한 덩어리 (심한 변비)",2:"2형 — 덩어리진 소시지형 (변비)",3:"3형 — 표면이 갈라진 소시지형 (정상)",4:"4형 — 매끈한 소시지형 (이상적)",5:"5형 — 무른 덩어리 (섬유질 부족)",6:"6형 — 죽처럼 흐물한 변 (가벼운 설사)",7:"7형 — 물 같은 변 (설사)"};
        return (
          <div style={{marginBottom:14,paddingTop:14,borderTop:`1px solid ${C.border}`}}>
            <div style={{fontSize:11.5,fontWeight:700,color:C.textMuted,marginBottom:8}}>🚽 배변 기록 (선택)</div>
            <div style={{fontSize:11.5,color:C.textMid,marginBottom:5}}>오늘 배변 횟수</div>
            <div style={{display:"flex",gap:4,marginBottom:10}}>
              {["없음","1회","2회","3회+"].map((l,i)=>{
                const on=bw.cnt===i;
                return <button key={i} onClick={()=>setBowel({...bw,cnt:on?null:i,type:on||i===0?null:bw.type})}
                  style={{flex:1,padding:"7px 2px",borderRadius:8,border:`1.5px solid ${on?C.gold:C.border}`,background:on?C.goldLight:C.surfaceAlt,color:on?C.gold:C.textMuted,fontSize:11,fontWeight:on?700:400,cursor:"pointer"}}>{l}</button>;
              })}
            </div>
            {bw.cnt!==null&&bw.cnt>0&&(
              <div>
                <div style={{fontSize:11.5,color:C.textMid,marginBottom:5}}>형태 (브리스톨 척도)</div>
                <div style={{display:"flex",gap:3,marginBottom:6}}>
                  {[1,2,3,4,5,6,7].map(t=>{
                    const on=bw.type===t;
                    const col=t<=2?C.caution:t<=4?C.safe:t===5?C.caution:C.warn;
                    return <button key={t} onClick={()=>setBowel({...bw,type:on?null:t})}
                      style={{flex:1,padding:"8px 0",borderRadius:8,border:`1.5px solid ${on?col:C.border}`,background:on?col+"22":C.surfaceAlt,color:on?col:C.textMuted,fontSize:12,fontWeight:on?800:400,cursor:"pointer"}}>{t}</button>;
                  })}
                </div>
                <div style={{fontSize:10.5,color:bw.type?(bw.type<=2?C.caution:bw.type<=4?C.safe:bw.type===5?C.caution:C.warn):C.textMuted,lineHeight:1.5,fontWeight:bw.type?600:400}}>
                  {bw.type?BRISTOL[bw.type]:"1~2 변비 · 3~4 정상 · 5~7 무른 변/설사"}
                </div>
              </div>
            )}
          </div>
      ...
      <div style={{marginBottom:14,paddingTop:14,borderTop:`1px solid ${C.border}`}}>
        <div style={{fontSize:11.5,fontWeight:700,color:C.textMuted,marginBottom:8}}>💊 복용 기록 (선택)</div>
        <div style={{display:"flex",flexWrap:"wrap",gap:5,marginBottom:8}}>
          {["유산균","비타민","소화제","지사제","변비약","복통약"].map(mn=>{
            const on=(meds||[]).includes(mn);
            return <button key={mn} onClick={()=>setMeds(pv=>on?(pv||[]).filter(x=>x!==mn):[...(pv||[]),mn])}
              style={{padding:"5px 11px",borderRadius:20,border:`1.5px solid ${on?"#8E6FC0":C.border}`,background:on?"#F3EFFA":C.surfaceAlt,color:on?"#8E6FC0":C.textMid,fontSize:11.5,fontWeight:on?700:400,cursor:"pointer"}}>{on?"✓ ":""}{mn}</button>;
          })}
          {(meds||[]).filter(mn=>!["유산균","비타민","소화제","지사제","변비약","복통약"].includes(mn)).map(mn=>(
            <button key={mn} onClick={()=>setMeds(pv=>(pv||[]).filter(x=>x!==mn))}
              style={{padding:"5px 11px",borderRadius:20,border:"1.5px solid #8E6FC0",background:"#F3EFFA",color:"#8E6FC0",fontSize:11.5,fontWeight:700,cursor:"pointer"}}>✓ {mn} ✕</button>
          ))}
        </div>
        <div style={{display:"flex",gap:6}}>
          <input value={medIn} onChange={e=>setMedIn(e.target.value)} onKeyDown={e=>{if(e.key==="Enter"&&medIn.trim()){setMeds(pv=>[...(pv||[]),medIn.trim()]);setMedIn("");}}}
            placeholder="약 이름 직접 입력 + Enter" style={{flex:1,padding:"8px 12px",border:`1px solid ${C.border}`,borderRadius:9,fontSize:11.5,outline:"none",background:C.surfaceAlt}} />
          <button onClick={()=>{if(medIn.trim()){setMeds(pv=>[...(pv||[]),medIn.trim()]);setMedIn("");}}}
            style={{padding:"8px 13px",background:"#8E6FC0",color:"#fff",border:"none",borderRadius:9,fontSize:11.5,fontWeight:700,cursor:"pointer"}}>추가</button>
        </div>
      </div>
...
function MiniCalendar({logs,mealPickDay,setMealPickDay,calMonth,setCalMonth,setLogView,setLogDate,setMeal,setMealFoods,setEditingId,setStep,setShowForm,setPain,setBloating,setComfort,setNote,setMealSymptoms,setSleep,setStress,setActivity,setBowel,setWater,setMeds,setLogs,C}) {
  const now = new Date();
            ...
            {de?(
              <div style={{padding:"12px 14px"}}>
                ...
                <div style={{display:"flex",gap:4,marginTop:8,marginBottom:10,flexWrap:"wrap"}}>
                  ...
                  {de.bowel&&de.bowel.cnt!==null&&<span style={{fontSize:11,padding:"2px 8px",borderRadius:20,background:C.surfaceAlt,color:C.textMid}}>🚽 {["없음","1회","2회","3회+"][de.bowel.cnt]}{de.bowel.type?" · "+de.bowel.type+"형":""}</span>}
                  {de.water&&<span style={{fontSize:11,padding:"2px 8px",borderRadius:20,background:"#EAF3FB",color:"#5B9BD5"}}>💧 {de.water}컵</span>}
                  {de.meds&&de.meds.length>0&&<span style={{fontSize:11,padding:"2px 8px",borderRadius:20,background:"#F3EFFA",color:"#8E6FC0"}}>💊 {de.meds.join("·")}</span>}
                  {de.note&&<span style={{fontSize:11,color:C.textMuted}}>{de.note}</span>}
                </div>
                <div style={{display:"flex",gap:8}}>
                  <button onClick={()=>{setEditingId(de.id);setLogDate(de.isoDate||iso);setMeal(de.meal||"아침");setMealFoods(de.mealFoods||em);setMealSymptoms(de.mealSymptoms||emptySymptoms);setPain(de.pain||0);setBloating(de.bloating||0);setComfort(de.comfort??3);setNote(de.note||"");setSleep(de.sleep??null);setStress(de.stress??null);setActivity(de.activity??null);setBowel(de.bowel||{cnt:null,type:null});setWater(de.water??null);setMeds(de.meds||[]);setStep(1);setMealPickDay(null);setShowForm(true);}}
...
function MainApp(p) {
  ...
  return (
    <div style={{maxWidth:480,margin:"0 auto",fontFamily:FF,background:C.bg,minHeight:"100vh"}}>
      ...
      <div style={{fontSize:9,color:C.textMuted,textAlign:"center",lineHeight:1.6,opacity:0.7,padding:"14px 20px 22px"}}>
        본 서비스의 프로그램·화면·콘텐츠 및 서비스 구성의<br/>무단 복제·배포·모방을 금지합니다.
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{maxWidth:480,margin:"0 auto",fontFamily:FF,background:"#FAFAF8",minHeight:"100vh"}}>
      ...
      <div style={{padding:"0 20px 20px"}}>
        ...
        <div style={{fontSize:9,color:"#A0A0A0",textAlign:"center",lineHeight:1.6,opacity:0.75,marginTop:18}}>
          본 서비스의 프로그램·화면·콘텐츠 및 서비스 구성의<br/>무단 복제·배포·모방을 금지합니다.
        </div>
      </div>
    </div>
...
export default function App() {
  ...
  const [bowel, setBowel]       = useState({cnt:null,type:null});
  ...
  const resetForm = () => {
    ...
    setSleep(null); setStress(null); setActivity(null); setBowel({cnt:null,type:null}); setWater(null); setMeds([]);
  ...
  const saveLog = () => {
    ...
    const entry = {
      id: editingId || Date.now(),date: selectedDate.toLocaleDateString("ko-KR",{month:"short",day:"numeric",weekday:"short"}),isoDate: logDate,mealFoods: allFoods,mealSymptoms,meal, foods: totalFoods,pain: Math.max(...MEALS.map(m=>allFoods[m]?.length?mealSymptoms[m]?.pain||0:0)),bloating: Math.max(...MEALS.map(m=>allFoods[m]?.length?mealSymptoms[m]?.bloating||0:0)),comfort: Math.round(MEALS.filter(m=>allFoods[m]?.length).reduce((s,m,_,a)=>s+(mealSymptoms[m]?.comfort??3),0)/Math.max(MEALS.filter(m=>allFoods[m]?.length).length,1)),sleep, stress, activity,bowel,water,meds,note,};
    if (editingId) {
    ...
    setDiningToast(editingId ? "✓ 기록이 수정됐어요!" : "✓ 기록이 저장됐어요!");
    setTimeout(()=>setDiningToast(""),3000);
  };
  const handleImg = (e) => {
